...
var TruffleContractMigrator = require('truffle-core/lib/commands/migrate')
...
module.exports = function (source) {
    ...
    if (!isCompilingContracts) {
        ...
        TruffleContractCompiler.compile(buildOpts, function (err, contracts) {
            ...
            // Once all of the contracts have been compiled, we know we
            // can immediately try to run the migrations safely.
            if (buildOpts.migrate != 'false') {
                TruffleContractMigrator.run(buildOpts, function (err) {
                    ...
                    // Finally return the contract source we were
                    // originally asked for.
                    returnContractAsSource(compiledContractPath,
                                           compilationFinished)
                })
            } else {
                returnContractAsSource(compiledContractPath,
